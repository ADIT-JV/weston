...
FILES_${PN} += "${systemd_unitdir} ${datadir}/wayland-sessions ${libdir}/libweston-2"
...
PACKAGECONFIG = "kms egl clients wayland"
...
do_install_append() {
	...
	install ${S}/recipes/weston/files/HMI-input.rules ${D}${sysconfdir}/udev/rules.d
